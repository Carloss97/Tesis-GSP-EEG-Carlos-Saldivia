...
4. **Links**: Use `[link text](https://example.com)` for links. Ensure that the link text is descriptive and the URL is valid.
5. **Images**: Use `![alt text](https://example.com/image.png)` for images. Include a brief description of the image in the alt text.

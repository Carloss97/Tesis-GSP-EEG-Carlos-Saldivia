# -*- coding: utf-8 -*-
"""
Created on Mon Mar 31 14:45:33 2025
...
def adjacency_matrix(X, k=None, radius=None, sigma=1.0, method='knn'):
    ...
    X = X - np.kron(np.ones((N, 1)), np.mean(X, axis=0))
    ...
    adj_matrix = lil_matrix((N,N))  # Matriz dispersa
...
def adaptive_edge_weighting(X, W0,sigma0, max_iter = 100):
    """

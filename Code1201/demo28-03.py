...
# %% Construcction skl
Wk_skl, WW = adjacency_matrix(X,k,sigma = sigma, method = 'knn')
...
from scipy.interpolate import NearestNDInterpolator, RBFInterpolator, SmoothSphereBivariateSpline
#ND
...
#y_SSI = SmoothSphereBivariateSpline(theta, phi, r)

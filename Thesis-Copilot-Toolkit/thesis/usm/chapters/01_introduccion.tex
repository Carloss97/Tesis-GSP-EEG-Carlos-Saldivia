...
Para garantizar reproducibilidad y cobertura sistemática, la ejecución se ancla en un registro exhaustivo de corridas experimentales (\texttt{it\_exhaustive\_from\_registry.json}), que fija explícitamente combinaciones de datasets, modos de pérdida, semillas, grafos y familias de métodos. Este diseño evita evaluaciones ad-hoc y permite trazar cada afirmación cuantitativa reportada en los capítulos posteriores hasta su artefacto experimental correspondiente.

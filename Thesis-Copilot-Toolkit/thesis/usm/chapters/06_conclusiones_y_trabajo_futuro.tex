...
\begin{enumerate}
    ...
    \item \textbf{Significancia estadística:} Las pruebas de Wilcoxon pareado rechazaron la hipótesis nula ($p < 0.05$) para el contraste de familias Temporal vs. Geométrica tanto en MAE como en DTW, confirmando que las diferencias observadas no son atribuibles a variabilidad aleatoria.
...
\begin{itemize}
    ...
    \item \textbf{Aceleración GPU:} Paralelizar las operaciones matriciales (producto Laplaciano, gradiente) en GPU mediante frameworks como CuPy o PyTorch, reduciendo la latencia de reconstrucción de segundos a milisegundos.

# Integration Log — it35_all4_kalofolias

**Decision**: GO ✓
**Date**: 2026-04-05
**Objective**: Kalofolias graph — all 4 datasets including physionet
...
- RMSE improvement: 25.0% at mr=0.4
- Significant contrast: mae_trss_vs_tikhonov (p=3.94e-03)
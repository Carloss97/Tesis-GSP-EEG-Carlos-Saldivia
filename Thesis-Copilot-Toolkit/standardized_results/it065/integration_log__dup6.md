# Integration Log: it65_bci_competition_multisubj
...
BCI Competition IV 2a proxy, 9 sujetos, kNN-k3

## Objetivo Científico

Generalización multi-sujeto de métodos TV en BCI proxy (N=9)
...
| Familia | MAE mediana |
|---------|-------------|
| TV/Tiempo | 4.569340e-07 |
| Instant | 6.631168e-07 |
| Mejora (%) | **31.1%** |

- **p-valor** (Mann-Whitney U): 4.49e-77
- **Mejor método TV**: `tv`
- **Mejor método Instant**: `gsmooth`
- **Mejor método overall**: `tv` (MAE=4.499216e-07)

## Hallazgo Científico

Los métodos TV/tiempo demuestran superioridad estadísticamente significativa (p=4.49e-77 < 0.05)
sobre métodos instantáneos en el dataset proxy, con una mejora del 31.1% en MAE mediano.

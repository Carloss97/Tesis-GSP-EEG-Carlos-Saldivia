# Stats QA Report — it16b_vknng_3syn
...
|------|--------|------------|--------|
| 1 | tv | 0.065500 | TV/Time |
| 2 | gsmooth | 0.065700 | Instant |
| 3 | mean | 0.065900 | Instant |
| 4 | idw | 0.066100 | Instant |
| 5 | heat_diffusion_temporal | 0.073700 | TV/Time |
| 6 | directed_tv | 0.076000 | TV/Time |
| 7 | linear | 0.078400 | Instant |
| 8 | trss | 0.080400 | TV/Time |
| 9 | gsp | 0.080900 | Instant |
...
|:--------------------------|:---------|:----------|:----------|------------:|:------------------|
| mae_trss_vs_tikhonov      | mae      | trss      | tikhonov  |   0.03038   | fail_to_reject_H0 |
| rmse_trss_vs_tikhonov     | rmse     | trss      | tikhonov  |   0.6236    | fail_to_reject_H0 |
| mae_tv_family_vs_instant  | mae      | tv_time   | instant   |   0.219     | fail_to_reject_H0 |
| dtw_tv_family_vs_instant  | dtw      | tv_time   | instant   | nan         | insufficient_data |
| rmse_tv_family_vs_instant | rmse     | tv_time   | instant   |   4.872e-05 | reject_H0         |

## Iteration Note

Retry of it16 with 3 datasets. VKNNG adapts k per node. n=3 per group. TV family shows 14-21% RMSE family gain.
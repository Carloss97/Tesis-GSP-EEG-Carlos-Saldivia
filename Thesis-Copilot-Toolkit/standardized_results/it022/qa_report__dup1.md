# Stats QA Report — it22_synthetic_broad_knn_k3_only
...
| QA-04 | N ≥ 1 per (method, scenario) | PASS |
...
|------|--------|------------|--------|
| 1 | directed_tv | 0.075700 | TV/Time |
| 2 | heat_diffusion_temporal | 0.080000 | TV/Time |
| 3 | idw | 0.083100 | Instant |
| 4 | tv | 0.083300 | TV/Time |
| 5 | trss | 0.083400 | TV/Time |
| 6 | gsmooth | 0.084000 | Instant |
| 7 | gsp | 0.084900 | Instant |
...
| mae_tv_family_vs_instant  | mae      | tv_time   | instant   |   0.5919  | fail_to_reject_H0 |
| dtw_tv_family_vs_instant  | dtw      | tv_time   | instant   | nan       | insufficient_data |
| rmse_tv_family_vs_instant | rmse     | tv_time   | instant   |   0.05005 | fail_to_reject_H0 |

## Iteration Note

KNN k=3 (3 nearest neighbors) on broadband EEG. n=1 per (method, scenario) — uses family median stats with min_n=1.
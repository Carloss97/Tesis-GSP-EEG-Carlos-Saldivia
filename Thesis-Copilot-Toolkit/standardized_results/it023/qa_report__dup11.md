# Stats QA Report — it23_synthetic_broad_knng_only
...
| 2 | heat_diffusion_temporal | 0.080100 | TV/Time |
| 3 | idw | 0.083100 | Instant |
| 4 | tv | 0.084000 | TV/Time |
| 5 | trss | 0.084100 | TV/Time |
| 6 | gsmooth | 0.084100 | Instant |
| 7 | spherical_spline | 0.085300 | Instant |
| 8 | mean | 0.085300 | Instant |
| 9 | gsp | 0.085400 | Instant |
...
| mae_tv_family_vs_instant  | mae      | tv_time   | instant   |   0.5218  | fail_to_reject_H0 |
| dtw_tv_family_vs_instant  | dtw      | tv_time   | instant   | nan       | insufficient_data |
| rmse_tv_family_vs_instant | rmse     | tv_time   | instant   |   0.03814 | fail_to_reject_H0 |

## Iteration Note

KNNG applies Gaussian kernel to edge weights. n=1 per (method, scenario). TV family shows 15-19% RMSE gain.
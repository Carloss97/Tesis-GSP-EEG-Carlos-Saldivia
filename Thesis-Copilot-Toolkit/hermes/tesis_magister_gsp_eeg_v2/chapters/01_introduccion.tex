...
% No veo que estas referencias sean sobre interpolación de  EEG.
...
\end{figure}
% No entiendo el proposito de esta figura.
...
\section{Cronología del Proyecto} %Sacar
...
\subsection{Fase 7 — Estudio de ablación (descomposición de componentes) y Documentación}
...
\end{quote} 
%(MNE-Python iguala o supera: Raro que la hipotesis sea desfavorable al método que tu propones.)
...
\section{Tesis, Contribución y Criterio de Lectura} %En  1.8 describes la  contribución, por qué lo vuelves a repetir?

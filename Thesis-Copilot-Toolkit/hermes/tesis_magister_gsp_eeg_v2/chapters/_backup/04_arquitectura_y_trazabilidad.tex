...
\caption[Cadena de trazabilidad experimental]{Cadena de trazabilidad experimental. La tesis exige que cada afirmación cuantitativa pueda rastrearse desde el texto hasta una tabla o figura, desde allí al archivo CSV correspondiente y finalmente al script/configuración que generó el resultado.}

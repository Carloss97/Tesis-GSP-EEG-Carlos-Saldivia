...
El cuarto aporte es la integración de una bitácora de artefactos, tablas y figuras que conecta afirmaciones, resultados y archivos. Esta estructura facilita reproducibilidad, revisión por terceros y extensión futura del trabajo. La Tabla~\ref{tab:ch8_objective_evidence} resume la matriz de cumplimiento de objetivos e hipótesis.

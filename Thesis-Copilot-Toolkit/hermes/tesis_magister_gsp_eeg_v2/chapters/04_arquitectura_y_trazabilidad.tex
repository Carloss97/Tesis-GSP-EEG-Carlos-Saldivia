...
\midrule
TRSS supera a MNE en SNR & Registros de métricas por escenario & Diferencia de SNR \\
15K configuraciones & Base de datos Optuna & Conteo de trials \\
MNE 50--100$\times$ más rápido & Registros de tiempo & Comparación de latencias \\
\bottomrule
\end{tabular}
\end{table}

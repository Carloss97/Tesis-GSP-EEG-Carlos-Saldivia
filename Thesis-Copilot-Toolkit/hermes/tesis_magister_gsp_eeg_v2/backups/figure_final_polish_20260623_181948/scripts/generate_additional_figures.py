...
def fig_gsp_concepts() -> None:
    fig = plt.figure(figsize=(7.45, 4.20))
    ...
    ax.legend(handles=handles, loc="upper center", bbox_to_anchor=(0.50, -0.18),
    ...
    box(ax, (0.06, 0.58), (0.18, 0.22), "canales\nobservados\n$P_\\Omega x$", C["green"], fontsize=9.2, weight="bold")
    box(ax, (0.06, 0.21), (0.18, 0.22), "canales\nfaltantes\n$P_{\\Omega^c}x$", C["red"], fontsize=9.2, weight="bold")
    box(ax, (0.40, 0.39), (0.26, 0.25), "problema regularizado\n$fidelidad + x^T Lx$", C["blue"], fontsize=9.7, weight="bold")
    box(ax, (0.78, 0.39), (0.17, 0.25), "estimación\n$\\hat{x}_{\\Omega^c}$", C["purple"], fontsize=9.7, weight="bold")
    box(ax, (0.40, 0.08), (0.26, 0.17), "grafo EEG\n$W, L$", C["orange"], fontsize=9.1, weight="bold")
    arrow(ax, (0.24, 0.69), (0.40, 0.54))
    arrow(ax, (0.24, 0.32), (0.40, 0.49))
    arrow(ax, (0.53, 0.25), (0.53, 0.39))
    arrow(ax, (0.66, 0.515), (0.78, 0.515))
...
def fig_architecture_blocks() -> None:
    ...
    exploratory = [
        ...
        ("Grafo + interpolación", "10 grafos · 18 métodos", C["blue"]),
    ]
    ys = [0.79, 0.66, 0.53]

...
La exclusión de Visibility NNK ilustra la importancia de esa trazabilidad. Al detectarse un error de implementación, sus salidas dejaron de usarse para ordenar métodos, justificar decisiones o sostener conclusiones. En un estudio con muchas variantes, esta decisión es metodológicamente relevante: no basta con reportar el mejor resultado; es necesario documentar qué resultados no son confiables y retirarlos de la cadena argumental.

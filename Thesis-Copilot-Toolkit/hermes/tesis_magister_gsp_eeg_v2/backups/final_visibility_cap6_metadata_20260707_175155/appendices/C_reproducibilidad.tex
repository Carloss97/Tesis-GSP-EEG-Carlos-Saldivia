...
Las reglas de exclusión deben aplicarse antes de sintetizar resultados. Se descartan ejecuciones con valores no numéricos, tiempos excesivos, identificadores duplicados inconsistentes o reconstrucciones triviales idénticas a la entrada. Además, la variante Visibility NNK se excluye de rankings, tablas de decisión y conclusiones porque se detectó un error de implementación durante la revisión final.

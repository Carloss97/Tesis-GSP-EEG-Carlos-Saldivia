...
def panel_origin(ax: plt.Axes) -> None:
    ...
    cx, cy, r = 0.37, 0.54, 0.29
    add_head_outline(ax, cx, cy, r, fill=True, facecolor=C["scalp"])
    ax.add_patch(Circle((cx, cy), 0.230, facecolor=C["skull"], edgecolor="#6E6E6E", lw=0.75, zorder=2))
    ax.add_patch(Circle((cx, cy), 0.175, facecolor=C["csf"], edgecolor="#6E6E6E", lw=0.75, zorder=3))
    ax.add_patch(Circle((cx, cy), 0.115, facecolor=C["cortex"], edgecolor="#5B3B25", lw=0.85, zorder=4))
    ...
    ax.text(0.68, 0.82, "Capas", transform=ax.transAxes,
            ha="left", va="center", fontsize=7.7, fontweight="bold", color="#111111")
    legend_item(ax, 0.68, 0.75, C["scalp"], "cuero cabelludo")
    legend_item(ax, 0.68, 0.67, C["skull"], "cráneo")
    legend_item(ax, 0.68, 0.59, C["csf"], "LCR")
    legend_item(ax, 0.68, 0.51, C["cortex"], "corteza")
    ax.text(0.68, 0.40, "Símbolos", transform=ax.transAxes,
            ha="left", va="center", fontsize=7.7, fontweight="bold", color="#111111")
    legend_item(ax, 0.68, 0.33, C["blue"], "electrodos", marker="eeg")
    legend_item(ax, 0.68, 0.25, C["orange"], "dipolos", marker="line")
    legend_item(ax, 0.68, 0.17, "#666666", "conducción", marker="line")

...
def panel_origin(ax: plt.Axes) -> None:
    ...
    # Compact explanation below the drawing, similar to Fig. 2.2(a); no swatch
    # legend is used because it became too cramped at final PDF size.
    ax.text(0.50, 0.095, "Capas: cuero cabelludo, cráneo, LCR, corteza",
            transform=ax.transAxes, ha="center", va="center", fontsize=7.9,
            color="#111111")
    ax.text(0.50, 0.035, "Símbolos: cuadrados = electrodos; flechas = dipolos",
            transform=ax.transAxes, ha="center", va="center", fontsize=7.9,
            color="#111111")

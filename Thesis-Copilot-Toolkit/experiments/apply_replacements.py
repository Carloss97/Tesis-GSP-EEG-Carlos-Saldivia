#!/usr/bin/env python3
"""
Apply text replacements to schedule and batch JSON files.
Creates .bak copies before writing changes when --apply is provided.
Usage:
  python apply_replacements.py --schedule path/to/schedule.json [--apply]
"""
import argparse

...
def main():
    ...
    for ds in datasets:
        ...
        fig.suptitle(f'Global Method Comparison - Dataset: {ds}', fontsize=16, fontweight='bold')
        ...
        axes[1].set_title('Log Spectral Distance (LSD) [0.5 - 45 Hz] - Lower is Better')
        ...
        plt.close()
        print(f"Global chart saved to {out_path}")

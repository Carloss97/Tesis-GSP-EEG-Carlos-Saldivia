...
The ablation study (Section~\ref{sec:ablation}) shows that temporal regularization provides only modest benefit ($+0.6\%$ MAE improvement, $p > 0.34$) on 5--10 second segments. Temporal advantage likely emerges in longer recordings with non-stationary dynamics (ERD/ERS, sleep architecture, seizure evolution). Future ablations should test task-specific scenarios explicitly.

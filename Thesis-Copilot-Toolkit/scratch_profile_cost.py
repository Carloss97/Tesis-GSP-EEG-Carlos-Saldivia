...
def profile_methods():
    ...
    sample_sizes = [250, 1000, 4000] # 1s, 4s, 16s
    
    print("\n--- INICIANDO PROFILING DE COSTO COMPUTACIONAL ---")
    print("Dataset: Physionet (64 canales) | Pérdida: Nearby 40% (25 canales)\n")
    ...
    for n_samples in sample_sizes:
        ...
        with warnings.catch_warnings():
            ...
            interpolate_signals('trss', data_missing, adjacency=adj, alpha=1.0, beta=0.1, lr=0.05, n_iter=80)

...
- `it123–it130` (restante): ejecutadas sin reabrir `it120`; resultados mixtos con **GO en it124 e it125** y NO-GO en `it123`, `it127`, `it128`, `it129`, `it130`.
...
- Pendiente único para cierre técnico completo del ciclo: rerun exhaustivo de `it120`.

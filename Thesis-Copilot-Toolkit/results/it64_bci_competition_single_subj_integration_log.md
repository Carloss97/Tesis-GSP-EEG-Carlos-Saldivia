# Integration Log: it64_bci_competition_single_subj
...
BCI Competition IV 2a proxy (22ch motor imagery), sujeto 1, kNN-k3

## Objetivo Científico

Validar interpolación GSP en señales de imaginería motora (BCI Competition proxy)
...
| Familia | MAE mediana |
|---------|-------------|
| TV/Tiempo | 5.211109e-07 |
| Instant | 7.473256e-07 |
| Mejora (%) | **30.3%** |

- **p-valor** (Mann-Whitney U): 5.95e-11
- **Mejor método TV**: `temporal_laplacian`
- **Mejor método Instant**: `mean`
- **Mejor método overall**: `temporal_laplacian` (MAE=4.848798e-07)

## Hallazgo Científico

Los métodos TV/tiempo demuestran superioridad estadísticamente significativa (p=5.95e-11 < 0.05)
sobre métodos instantáneos en el dataset proxy, con una mejora del 30.3% en MAE mediano.

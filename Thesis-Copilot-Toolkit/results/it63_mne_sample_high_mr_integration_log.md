# Integration Log: it63_mne_sample_high_mr
...
MNE Sample proxy, escenario de alta tasa de pérdida (30-40%)

## Objetivo Científico

Robustez de métodos TV ante alta pérdida en señales auditivas densas
...
| Familia | MAE mediana |
|---------|-------------|
| TV/Tiempo | 2.122063e-07 |
| Instant | 3.038537e-07 |
| Mejora (%) | **30.2%** |

- **p-valor** (Mann-Whitney U): 1.33e-07
- **Mejor método TV**: `trss`
- **Mejor método Instant**: `puy`
- **Mejor método overall**: `trss` (MAE=2.005584e-07)

## Hallazgo Científico

Los métodos TV/tiempo demuestran superioridad estadísticamente significativa (p=1.33e-07 < 0.05)
sobre métodos instantáneos en el dataset proxy, con una mejora del 30.2% en MAE mediano.

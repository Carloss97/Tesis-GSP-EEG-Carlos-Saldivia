# HISTÓRICO — Plan de trabajo: de tesis aprobada a paper publicable en Biomedical Signal Processing and Control

> **Plan reemplazado.** El plan vigente es `docs/plans/2026-07-23-plan-ieee-tbme-from-thesis.md`: artículo IEEE TBME nuevo, doble columna, tesis como fuente principal y sin nuevos experimentos.
